...
const TimeTable = ({ changedTimeTable, today, todayWeek }) => {
    ...
    return (
        <div className='timetable-grid'>
            ...
            <h1 style={{ gridRowStart: '2' }} className='timetable-week'>Monday</h1>
            <h1 style={{ gridRowStart: '3' }} className='timetable-week'>Tuesday</h1>
            <h1 style={{ gridRowStart: '4' }} className='timetable-week'>Wednesday</h1>
            <h1 style={{ gridRowStart: '5' }} className='timetable-week'>Thursday</h1>
            <h1 style={{ gridRowStart: '6' }} className='timetable-week'>Friday</h1>
